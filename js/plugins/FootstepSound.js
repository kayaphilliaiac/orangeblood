...
(function () {
    ...
    var footStepJson = {
        ...
        always: {
            interval:2,
            walk1:{name:'01_walk', volume:40, pitch:80, pan:0},
            walk2:{name:'', volume:90, pitch:100, pan:0},
            dash1:{name:'01_run', volume:60, pitch:80, pan:0},
        ...
        region1: {
            interval:2,
            walk1:{name:'01_metalwalk', volume:40, pitch:80, pan:0},
            walk2:{name:'', volume:90, pitch:100, pan:0},
            dash1:{name:'01_metal', volume:60, pitch:80, pan:0},
            dash2:{name:'', volume:90, pitch:100, pan:0},
        },
    };
    //=============================================================================
