...
Imported['MiniInformationWindow'] = 1.01;
/*:
 * @plugindesc ver1.01/さまざまな情報を表示するミニウィンドウを定義します。
 * @author Yana
 *
 * @param 【基本設定】
 *
...
(function() {
    ...
    Window_Selectable.prototype.processHandling = function() {
        ...
        if (this.isOpenAndActive() && this._infoWindow && this.isIwSwitchTriggered()) {
            this._infoWindow._showInfo = !this._infoWindow._showInfo;
            if (this._infoWindow._showInfo){
                this._infoWindow.open();
                this.updateHelp();
            }
            if (!this._infoWindow._showInfo) this._infoWindow.close();
        }
    };
    ...
    Window_Selectable.prototype.setMiniWindow = function(item) {
        if (this._infoWindow){
            if (this.active && item) {
                ...
                this._infoWindow.setItem(item, rect);
            } else {
    ...
    Scene_Base.prototype.createMiniWindow = function() {
        ...
        if (this._buyWindow) this._buyWindow._infoWindow = this._miniWindow;
        if (this._sellWindow) this._sellWindow._infoWindow = this._miniWindow;
        if (this._slotWindow) this._slotWindow._infoWindow = this._miniWindow;
        if (this._itemWindow) this._itemWindow._infoWindow = this._miniWindow;
