...
/*:
 * @plugindesc 【ver.3.11】マウスやタッチ操作を変更します。
 * @author 木星ペンギン
 *
 * @help プラグインコマンド:
...
TouchInput._onTrigger = function(x, y) {
    Alias.ToIn__onTrigger.call(this, x, y);
    this.mppStartX = x;
    this.mppStartY = y;
};
...
Window_Selectable.prototype.onTouch = function(triggered) {
    if (triggered) {
        ...
        } else if (ConfigManager.okType < 2 || TouchInput.isMppDoubleTap()) {
            TouchInput.clearMppInterval();
            this._stayCount = 0;
